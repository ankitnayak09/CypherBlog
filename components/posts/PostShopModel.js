...
<h1 className=" text-3xl my-4 ml-6 text-left font-bold tracking-tight text-pri-text-gray ">Share</h1>
                  ...
                  <Link href={`whatsapp://send?text=${process.env.NEXT_PUBLIC_FRONTEND_HOST}/post/${postId}`}
...
>
                  ...
                  <CopyToClipboard text={`${process.env.NEXT_PUBLIC_FRONTEND_HOST}/post/${postId}`}
